...
@Table(
        ...
        indexes = {
                ...
                @Index(name = "idx_ticket_staff", columnList = "staff_id"),
...
public final class Ticket {
    ...
    @NotNull
    @ManyToOne(fetch = FetchType.LAZY, optional = false)
    @JoinColumn(name = "staff_id", nullable = false, foreignKey = @ForeignKey(name = "fk_ticket_staff"))
    ...
    // It can be null.
    @Size(max = 1000)
    @Column(name = "staff_content", length = 1000)
    ...
    public String toString() {
        ...
        sb.append(", staffContent='").append(staffContent).append('\'');
